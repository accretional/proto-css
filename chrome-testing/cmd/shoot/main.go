...
func main() {
	values := flag.String("values", "chrome-testing/generated/values.json", "values.json path")
	manifest := flag.String("manifest", "chrome-testing/generated/manifest.tsv", "manifest path (for family ids)")
