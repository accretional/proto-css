...
├── run.sh                       # Pipeline for templates + generated (--template, --generated)
...
# Generated only (includes EBNF generation)
./run.sh --generated

# First 20 generated properties only
START=0 COUNT=20 ./run.sh --generated

# Rebuild galleries only (no screenshots)
./run.sh --gallery-only
