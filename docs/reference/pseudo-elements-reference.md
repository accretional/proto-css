...
Pseudo-elements are like sub-elements or partial elements
...
https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Selectors/::checkmark
...
https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Selectors/::first-letter
https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Selectors/::first-line
https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Selectors/::grammar-error
...
https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Selectors/::picker-icon
...
https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Selectors/::scroll-marker-group
...
https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Selectors/::spelling-error
https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Selectors/::target-text
https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Selectors/::view-transition
https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Selectors/::view-transition-group
https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Selectors/::view-transition-image-pair
https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Selectors/::view-transition-new
